...
const char *ssid = "KING_wifi"; // Put your SSID here
const char *password = "king15963"; // Put your PASSWORD here
...
void serverStream() {
  ...
  while (1) {
    ...
    int shake_value = digitalRead(shake_pin);

    Serial.println(shake_value);

    if (shake_value == 0){
      if (shake == 0 && shake_cnt <= 5){
        shake = 1;
        std_time = millis();
      }
